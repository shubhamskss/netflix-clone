...
const dispatch=useDispatch()
    ...
    if(!useIsTokenExpired(localStorage.getItem("userToken")))
...
{fullName &&location.pathname!=="/"&& <div className='flex items-center px-6'>
    <IoIosArrowDropdown size="24px" color="white"/>
    <h1 className="text-lg font-medium text-white" >{fullName}</h1>
    <div className='ml-4'>
